...
namespace Facebook.WitAi.Configuration
{
    ...
    public class WitRuntimeConfiguration
    {
        ...
        [SerializeField]
        public float minKeepAliveVolume = .0002f;
        ...
        [SerializeField]
        public float minKeepAliveTimeInSeconds = 150f;
        ...
        [SerializeField]
        public float minTranscriptionKeepAliveTimeInSeconds = 30f;

        [Tooltip("The maximum amount of time in seconds the mic will stay active")]
        [DynamicRange("RecordingTimeRange")]
        [SerializeField]
        public float maxRecordingTime = 60;

        protected virtual Vector2 RecordingTimeRange => new Vector2(0, 150);
        ...
        [SerializeField] public float soundWakeThreshold = .0002f;
